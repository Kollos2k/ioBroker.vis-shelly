<!-- the full description of format in data-vis-attrs can be found here:
    https://github.com/ioBroker/ioBroker.vis/blob/master/www/js/visEditInspexct.js#L39

    ----------------------------------------------------------
    Mandatory XML attributes:
        id="tplVis-shellyWIDGETNAME"
        type="text/ejs"
        class="vis-tpl"
    ...
    data-vis-prev
        ...
        data-vis-prev='<img src="widgets/hqwidgets/img/prev/Prev_tplVis-shellyShowInstance.png"></img>'
