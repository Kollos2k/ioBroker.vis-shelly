...
vis.binds["vis-shelly"] = {
	...
	createAllDevicesWidget: function (widgetID, view, widData, style, byRoom = false) {
		...
		var buildDevice = function (val) {
			...
			const basicUpdateValue = function ($dom, newVal, options = {}, data = {}, stageID = "") {
				$dom.html(newVal);
			};
			const basicUpdateMotionValue = function ($dom, newVal, options = {}, data = {}, stageID = "") {
			...
			const basicUpdateValueName = function ($dom, newVal, optons = {}, data = {}, stageID = "") {
				var name = null;
				var oname = null;
				$.each(data, (k, v) => {
				...
				if (oname == null || typeof oname != "object") oname = { val: "" };
				$dom.html(oname.val.length > 0 ? oname.val : name.val);
			};
			const basicUpdateValueUnit = function ($dom, newVal, options = {}, data = {}, stageID = "") {
				$dom.html(newVal + " " + options.unit);
			};
			const basicUpdateValueBrightness = function ($dom, newVal, options = {}, data = {}, stageID = "") {
				$dom.html(newVal + " " + options.unit);
			...
			const basicUpdateDevicePower = function ($dom, newVal, options = {}, data = {}, stageID = "") {
			...
			const basicUpdateSwitch = function ($dom, newVal, options = {}, data = {}, stageID = "") {
			...
			const basicSwitchAction = function (stateID, $mainDOM) {
			...
			switch (val.type) {
				case "SHDM-2":
					typeConfig = {
						domID: domID,
						update: {
							power: { name: "power", unit: "W", updateValue: basicUpdateValueUnit },
							brightness: { name: "brightness", unit: "%", updateValue: basicUpdateValueBrightness },
							name: { name: "name", updateValue: basicUpdateValueName },
							oname: { name: "name", updateValue: basicUpdateValueName },
							switch: { name: "switch", updateValue: basicUpdateSwitch },
						},
						view: {
							info: {
				...
				case "shellyplus1pm":
					typeConfig = {
						...
						update: {
							power: { name: "power", unit: "W", updateValue: basicUpdateValueUnit },
							voltage: { name: "voltage", unit: "V", updateValue: basicUpdateValueUnit },
							name: { name: "name", updateValue: basicUpdateValueName },
							oname: { name: "name", updateValue: basicUpdateValueName },
							switch: { name: "switch", updateValue: basicUpdateSwitch },
						},
